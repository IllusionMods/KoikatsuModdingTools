...
namespace AmplifyColor
{
    ...
    public class VolumeEffectField
    {
        ...
        public void UpdateValue(object val)
        {
            switch (fieldType)
            {
                case "System.Single": valueSingle = (float)val; break;
                case "System.Boolean": valueBoolean = (bool)val; break;
                case "UnityEngine.Color": valueColor = (Color)val; break;
                case "UnityEngine.Vector2": valueVector2 = (Vector2)val; break;
                case "UnityEngine.Vector3": valueVector3 = (Vector3)val; break;
                case "UnityEngine.Vector4": valueVector4 = (Vector4)val; break;
            }
        }
    }
