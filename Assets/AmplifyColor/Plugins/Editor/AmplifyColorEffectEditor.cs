...
{
    private SerializedProperty tonemapper;
    private SerializedProperty exposure;
    private SerializedProperty linearWhitePoint;
    private SerializedProperty useDithering;
    private SerializedProperty qualityLevel;
    private SerializedProperty blendAmount;
    private SerializedProperty lutTexture;
    private SerializedProperty lutBlendTexture;
    private SerializedProperty maskTexture;
    private SerializedProperty useDepthMask;
    private SerializedProperty depthMaskCurve;
    private SerializedProperty useVolumes;
    private SerializedProperty exitVolumeBlendTime;
    private SerializedProperty triggerVolumeProxy;
    private SerializedProperty volumeCollisionMask;
    ...
    private void ToggleContextTitle(SerializedProperty prop, string title)
    {
        GUILayout.Space(5);
