...
namespace AmplifyColor
{
    public class AmplifyColorVolumeEditor : EditorWindow
    {
        ...
        private class NewLineContainer
        {
        ...
        private const int iconMinWidth = 20, iconMaxWidth = 43;
        private const int activeMinWidth = 10, activeMaxWidth = 40;
        private const int visibleMinWidth = 10, visibleMaxWidth = 40;
        private const int selectWidth = 16;
        private const int nameMinWidth = 59, nameMaxWidth = 305;
        private const int blendMinWidth = 20, blendMaxWidth = 94;
        private const int priorityMinWidth = 20, priorityMaxWidth = 40;
        private const int exposureMinWidth = 30, exposureMaxWidth = 50;
        private const int lutWidth = 40;
        private const int minIndentWidth = 0, maxIndentWidth = 8;
        private const int minColumnWidth = 19, maxColumnWidth = 90;
        private const int minValueWidth = 100, maxValueWidth = 200;

        private Texture2D volumeIcon = null;
        private string editName = "";
        private GameObject editObject = null;
        private readonly Dictionary<string, NewLineContainer> copyLines = new Dictionary<string, NewLineContainer>();
        ...
        private static string GetEditorPrefsKey(AmplifyColorVolumeBase volume)
        {
            return "AmplifyColor.VolumeEditor.Foldout." + volume.GetHashCode();
        }

        private bool SetFoldout(AmplifyColorVolumeBase volume, bool state)
        {
            EditorPrefs.SetBool(GetEditorPrefsKey(volume), state);
            return state;
        }

        private bool GetFoldout(AmplifyColorVolumeBase volume)
        {
        ...
        private void DrawHeader(List<AmplifyColorVolumeBase> volumes)
        {
        ...
        private void DrawVolumeEffects(AmplifyColorVolumeBase volume)
        {
        ...
        private Vector4 DrawFixedVector4Field(Vector4 vec)
        {
        ...
        private void DrawVolumeEffectFields(AmplifyColorVolumeBase volume)
        {
        ...
        private void DrawLut(AmplifyColorVolumeBase volume)
        {
            GUILayout.Space(0);
        ...
        private readonly double searchDelayDuration = 0.25f;
